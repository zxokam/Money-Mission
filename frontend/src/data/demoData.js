...
export const demoEvaluation = {
  ai_verdict: "accepted",
  status: "completed",
  improvement_percentage: 13.5,
  target_improvement_percentage: 10,
  expected_leftover: 680,
  actual_leftover: 148,
  actual_total_spending: 2652,
  reward_unlocked: true,
  reward: 20,
  reason: "Bank transactions show a 13.5% reduction in wasteful spending. Shopping and food delivery dropped significantly. Target of 10% was exceeded.",
  observed: "Spending across 6 categories totaled RM2,652. Food and transport were within budget. Shopping dropped by RM45 compared to baseline. No unexplained large transactions detected.",
  ai_explanation: "You cut shopping by RM45 and reduced food delivery by RM32. Leftover grew from RM80 to RM148. Health score jumped from 62 to 76.",
  passed_checks: [
  ...
  recommendations: ["Keep limiting food delivery", "Consider reducing subscription costs further"],
  non_essential_spending: 189,
  essential_spending: 940,
  final_financial_score: 76,
  score_change: 14,
  categoryBreakdown: [
...
export const demoRejectedEvaluation = {
  ...
  expected_leftover: 680,
  actual_leftover: 82,
  actual_total_spending: 2718,
  reward_unlocked: false,
  reward: 30,
  reason: "AI detected 3 GrabFood orders and 2 Foodpanda orders during the mission period. The public transport only rule was violated multiple times.",
  observed: "Bank transactions revealed 3 Grab rides on May 4, 12, and 19 totaling RM45. Additionally, 5 food delivery orders were found totaling RM128. Essential expenses remained within budget but discretionary transport exceeded the limit.",
  ai_explanation: "While you submitted photos for most rides, AI cross-referenced your bank transactions and found Grab payments on May 4, 12, and 19. Additionally, 3 photos showed car dashboards instead of bus/train tickets.",
  passed_checks: [
  ...
  recommendations: ["Switch to public transport for all commutes", "Delete food delivery apps during challenge"],
  non_essential_spending: 238,
  essential_spending: 940,
  final_financial_score: 63,
  score_change: 1,
  categoryBreakdown: [
